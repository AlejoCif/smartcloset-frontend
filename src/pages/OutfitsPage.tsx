...
import { sugerirOutfitsAvanzado, guardarOutfit, getOutfits, getCapsule } from '../api/outfits'
import Layout from '../components/Layout'
import LoadingSpinner from '../components/LoadingSpinner'
import type { OutfitSugerido, Outfit, CapsuleResponse, Estilo, SugerirRequest } from '../types'
...
export default function OutfitsPage() {
  ...
  const handleGuardar = async (sug: OutfitSugerido, index: number) => {
    ...
    try {
      await guardarOutfit(sug.nombre, sug.prendaIds, sug.estilo)
