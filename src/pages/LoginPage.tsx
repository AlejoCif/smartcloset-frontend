    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center bg-[#FAF7F2] px-6 py-10 md:py-0">
        <div className="w-full max-w-sm">
          ...
          {/* Botón Google */}
          {googleLoading ? (
            <div className="w-full flex items-center justify-center py-3.5 border border-primary/20 rounded-xl">
              <span className="text-primary/50 font-body text-sm">Conectando...</span>
            </div>
          ) : (
